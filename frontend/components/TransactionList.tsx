...
const toneClasses: Record<ActivityItem["tone"], string> = {
  success: "border-[#bce7d5] bg-[#edf9f3] text-[#1a5a40]",
  error: "border-[#f7c4cd] bg-[#fff0f2] text-[#a33a51]",
  info: "border-[#f8b4c6]/50 bg-white text-[#6a4a56]",
};
    ...
    <section className="rounded-[34px] border border-white/80 bg-white/72 p-7 shadow-[0_18px_48px_rgba(244,114,158,0.12)] backdrop-blur-md lg:p-8">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <h2 className="mt-4 text-3xl font-extrabold leading-[1.08] text-[#242124]">
            Recent
          </h2>
        </div>
      </div>
